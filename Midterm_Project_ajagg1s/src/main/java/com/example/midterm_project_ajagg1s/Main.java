...
public class Main extends Application{
            ...
            if (event.getSource() == myButton1) {
                ...
                if (myRadio1.isSelected()) {
                    teamList.add(new Service (input1.getText(), oracleEmployeeContract.getProjectName(), "Employee Finder",
                            oracleEmployeeContract.getClientAssociation().getName(), oracleEmployeeContract.getClientAssociation().getVolume(), 100.0, 100.0));
                    ...
                    teamList.add(new Service (input1.getText(), johnJobContract.getProjectName(), "Job Finder",
                            johnJobContract.getClientAssociation().getName(), johnJobContract.getClientAssociation().getVolume(), 100.0, 200.0));
    ...
    class newStage extends Stage {
        ...
        public void timeReport () {
            ...
            serviceTable.setItems(FXCollections.observableArrayList(teamList));
